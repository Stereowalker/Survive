...
public class SBlocks {
	...
	public static final Block PURIFIED_WATER_CAULDRON = new LayeredCauldronBlock(Precipitation.NONE, SCauldronInteraction.PURIFIED_WATER, VersionHelper.copyBlockPropertyWithId(Blocks.CAULDRON, "survive:purified_water_cauldron"));

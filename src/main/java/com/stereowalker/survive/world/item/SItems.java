...
public class SItems {
	...
	public static final Item WOOL_HAT = new ArmorItem(SArmorMaterials.WOOL, ArmorItem.Type.HELMET, new Item.Properties());
	@RegistryObject("wool_jacket")
	public static final Item WOOL_JACKET = new ArmorItem(SArmorMaterials.WOOL, ArmorItem.Type.CHESTPLATE, new Item.Properties());
	@RegistryObject("wool_pants")
	public static final Item WOOL_PANTS = new ArmorItem(SArmorMaterials.WOOL, ArmorItem.Type.LEGGINGS, new Item.Properties());
	@RegistryObject("wool_boots")
	public static final Item WOOL_BOOTS = new ArmorItem(SArmorMaterials.WOOL, ArmorItem.Type.BOOTS, new Item.Properties());
	...
	public static final Item STIFFENED_HONEY_HELMET = new ArmorItem(SArmorMaterials.STIFFENED_HONEY, ArmorItem.Type.HELMET, new Item.Properties());
	@RegistryObject("stiffened_honey_chestplate")
	public static final Item STIFFENED_HONEY_CHESTPLATE = new ArmorItem(SArmorMaterials.STIFFENED_HONEY, ArmorItem.Type.CHESTPLATE, new Item.Properties());
	@RegistryObject("stiffened_honey_leggings")
	public static final Item STIFFENED_HONEY_LEGGINGS = new ArmorItem(SArmorMaterials.STIFFENED_HONEY, ArmorItem.Type.LEGGINGS, new Item.Properties());
	@RegistryObject("stiffened_honey_boots")
	public static final Item STIFFENED_HONEY_BOOTS = new ArmorItem(SArmorMaterials.STIFFENED_HONEY, ArmorItem.Type.BOOTS, new Item.Properties());

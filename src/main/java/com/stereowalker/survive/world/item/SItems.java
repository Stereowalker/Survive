...
public class SItems {
	...
	public static final Item REALISTIC_CAMPFIRE = new BlockItem(SBlocks.REALISTIC_CAMPFIRE, new Item.Properties().component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));

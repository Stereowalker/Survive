...
public class ServerConfig {
	...
	//
	//Temperature
	@UnionConfig.Entry(group = "Temperature" , name = "Dimensional Temperature Modifier", side = ConfigSide.Server)
	...
	@UnionConfig.Entry(group = THIR , name = "Expanded Stomach Capacity", side = ConfigSide.Server)
	...
	@UnionConfig.Entry(group = MISC , name = "Should Purified Water Cauldron Revert", side = ConfigSide.Server)
	...
	@UnionConfig.Entry(group = MISC , name = "Animal Fat Drops", side = ConfigSide.Server)
	@UnionConfig.Comment(comment = {"Should Animal Fat drop from animals upon death?"})
	public static boolean animalFatDrops = true;
	
	@UnionConfig.Entry(group = MISC , name = "Status Book Crafting", side = ConfigSide.Server)

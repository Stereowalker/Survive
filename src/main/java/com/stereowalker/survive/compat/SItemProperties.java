...
//		ItemProperties.register(SItems.THERMOMETER, VersionHelper.toLoc("temperature"), (stack, level, livingentity, count) -> { TODO 26.1
...
//					for (Entry<Identifier, Tuple<TemperatureQuery, ContributingFactor>> query : TemperatureQuery.queries.entrySet()) {
